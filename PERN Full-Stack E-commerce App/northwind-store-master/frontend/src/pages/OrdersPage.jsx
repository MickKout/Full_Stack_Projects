...
function OrdersPage() {
  ...
  if (error) {
    return (
      <PageError message="Could not load orders." action={{ to: "/", label: "Back to storefront" }} />
    );
  }
  ...
  return (
    <div className="text-left">
      ...
      <p className="mb-8 text-sm text-base-content/70">
        {staff
          ? "All orders in the storefront. Open one to continue customer support."
          : "Paid orders include support: open an order to continue the conversation."}
      </p>
